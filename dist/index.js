...
var http = __importStar(__nccwpck_require__(925));
...
function fetchAccessToken() {
    return __awaiter(this, void 0, void 0, function () {
        var client, data, reqURL, res, _a, _b;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    client = new http.HttpClient('matrix-message-action');
                    data = { user: user, password: password, type: 'm.login.password' };
                    reqURL = getBaseURL(server) + "/_matrix/client/r0/login";
                    return [4 /*yield*/, client.post(reqURL, JSON.stringify(data))];
                case 1:
                    res = _c.sent();
                    _b = (_a = JSON).parse;
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    client = new http.HttpClient('matrix-message-action');
                    reqURL = getBaseURL(server) + "/_matrix/client/r0/rooms/" + roomID + "/send/m.room.message?access_token=" + accessToken;
                    return [4 /*yield*/, client.post(reqURL, JSON.stringify(getMatrixMessage()))];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
